...
-   *CAREER: Quantifying heterogeneity and uncertainty in the transmission of vector borne diseases with a Bayesian trait-based framework*. NSF DMS/DEB #1750113
...
The [bayesTPC](https://github.com/johnwilliamsmithjr/bayesTPC) *R* package is for Bayesian fitting of Thermal Performance Curves (TPCs) to trait responses. The package is built using the [nimble](https://r-nimble.org/) language and machinery as the underlying engine for Markov Chain Monte Carlo (MCMC). Our main aims in releasing bayesTPC were to support the adoption of Bayesian approaches in thermal physiology, and to promote TPC fitting that adequately quantifies uncertainty. For a bit more information, take a look at the [blog post about the paper](https://www.vectorbyte.org/blog/paper-introducing-bayestpc-is-out-in-methods-in-ecology-and-evolution) over at the [VectorByte Initiative](https://www.vectorbyte.org).

- Paper: [Sorek, S., Smith, J. W. Jr., Huxley, P. J., & Johnson, L. R. (2025). `bayesTPC`: Bayesian inference for thermal performance curves in *R*. Methods in Ecology and Evolution, 16, 687–697.](https://doi.org/10.1111/2041-210X.70004){.external target="_blank"}
- [**bayesTPC** git repository](https://github.com/johnwilliamsmithjr/bayesTPC){.external target="_blank"}
...
-   Paper: [Boersch‐Supan, P.H., Ryan, S.J. and Johnson, L.R., 2017. "deBInfer: Bayesian inference for dynamical models of biological systems in R". *Methods in Ecology and Evolution*, 8(4), pp.511-518.](https://besjournals.onlinelibrary.wiley.com/doi/full/10.1111/2041-210X.12679){.external target="_blank"}
-   Package: [**deBInfer** package on CRAN](https://cran.r-project.org/web/packages/deBInfer/index.html){.external target="_blank"}
